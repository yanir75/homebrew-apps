class Kubehcl < Formula
    ...
    url "https://github.com/yanir75/kubehcl/releases/download/v0.1.13/kubehcl.tar.gz", using: :curl
    sha256 "08574b5d76dd1cb21478cd0f0b1c7f1f2587952f94b1e48d061c9c901bdc0cfb" # SHA256 checksum of the tarball
