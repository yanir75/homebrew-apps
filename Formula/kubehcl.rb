class Kubehcl < Formula
    ...
    url "https://github.com/yanir75/kubehcl/releases/download/v0.1.14/kubehcl.tar.gz", using: :curl
    sha256 "d3a578a77d41a20875d17e91d3d9298d76b0b5d20c4ec851860b1c0a5f2da20f" # SHA256 checksum of the tarball
