class Kubehcl < Formula
    ...
    url "https://github.com/yanir75/kubehcl/releases/download/v0.2.0/kubehcl.tar.gz", using: :curl
    sha256 "ec19ba8b73dd6140c6ad87440d9401980d84aa3b010036f4fe703ac860728b23" # SHA256 checksum of the tarball
