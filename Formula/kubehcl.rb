class Kubehcl < Formula
    ...
    url "https://github.com/yanir75/kubehcl/releases/download/v0.1.3/kubehcl.tar.gz", using: :curl
    sha256 "a2e0b282429ba9f70a1b060d71c394bdbc719f5bbe6964d69af26a927bde7271" # SHA256 checksum of the tarball
