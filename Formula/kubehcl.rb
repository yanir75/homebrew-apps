class Kubehcl < Formula
    ...
    url "https://github.com/yanir75/kubehcl/releases/download/v0.1.7/kubehcl.tar.gz", using: :curl
    sha256 "3364ac0b6de77d7b6ace2fb54d239ea27779721404d72b1b59c3e55a2516f70b" # SHA256 checksum of the tarball
